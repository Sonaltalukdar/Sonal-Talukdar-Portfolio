...
const links = [
  ...
  { label: 'Additional Skills', href: '#skills' },
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span style={{ color: '#22e5ff' }}>_.</span>Sonal
          <span style={{ color: '#22e5ff' }}>Talukdar</span>
        </a>
          ...
          {links.map((l) => {
            ...
            return (
              <motion.a
                ...
                className="group relative block overflow-hidden text-base leading-none"
